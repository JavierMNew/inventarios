    ...
    <form action="/api/auth/register" method="post" className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        <Field>
          ...
          <Input id="first_name" name="first_name" type="text" placeholder="Javier" required />
          <Input id="last_name" name="last_name" type="text" placeholder="Montero" required />
        </Field>
        <Field>
          <FieldLabel htmlFor="phone">Teléfono</FieldLabel>
          <Input id="phone" name="phone" type="text" placeholder="123456789" required />
          <FieldDescription>
            Usaremos este teléfono para contactarte. No compartiremos tu teléfono con nadie más.
          </FieldDescription>
        </Field>
        <Field>
          ...
          <FieldDescription>
            Usaremos este correo para contactarte. No compartiremos tu correo con nadie más.
          </FieldDescription>
        </Field>
        <Field>
